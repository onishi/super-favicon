...
- `app/src/main/res/drawable-*dpi/ic_launcher_foreground.png` — アプリアイコン（iOS版 `ios/SuperFaviconBrowser/Assets.xcassets/AppIcon.appiconset/icon.png` と共通のロゴを密度別に書き出したもの）
